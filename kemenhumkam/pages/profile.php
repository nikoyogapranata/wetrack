...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/wetrack/Lapas/css/setting.css">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link rel="stylesheet" href="http://localhost/wetrack/Lapas/css/profile.css">
    <link
...
<body>
    <div class="container">
        <aside class="sidebar">
            ...
            <nav class="nav-links">
                <ul>
                    <li><a href="http://localhost/wetrack/Lapas/pages/home.php"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a></li>
                    ...
                    <li class="active"><a href="http://localhost/wetrack/Lapas/pages/setting.php"><i class="fas fa-cog"></i> <span>Settings</span></a></li>
                </ul>
            </nav>
        ...
        <main class="content">
            ...
            <div class="profile-container">
                <div class="path-to-back">
                    <a href="http://localhost/wetrack/Lapas/pages/setting.php"><i class="fas fa-arrow-left"></i></a>
                </div>
                <h1>Administrative Staff</h1>
                <img src="http://localhost/wetrack/Lapas/Image/lapas-logo.png" alt="Photo Profile">
                <h2>Serdy Fambo</h2>
                <p>NIP. 06-30-21</p>
