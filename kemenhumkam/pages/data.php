...
<head>
    ...
    <link rel="stylesheet" href="/wetrack/admin/css/data.css">
    <script src="/wetrack/admin/js/data.js" defer></script>
        ...
        <aside class="sidebar">
            ...
            <nav class="nav-links">
                <ul>
                    ...
                    <li><a href="/wetrack/admin/pages/Laporan.php"><i class="fas fa-file-invoice"></i><span>Final
                                Report</span></a></li>
