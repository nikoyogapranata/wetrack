...
<head>
    ...
    <script src="/wetrack/kemenhumkam/js/data.js"></script>
        ...
        <aside class="sidebar">
            ...
            <nav class="nav-links">
                <ul>
                    ...
                    <li><a href="/wetrack/kemenhumkam/pages/data.php"><i class="fas fa-database"></i>
                            <span>Database</span></a></li>
                    <li class="active"><a href="/wetrack/kemenhumkam/pages/Laporan.php"><i
