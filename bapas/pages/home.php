...
<body>
    <div class="container">
        <aside class="sidebar">
            ...
            <nav class="nav-links">
                <ul>
                    <li class="active"><a href="/frontend/pages/Bapas/html/home.html"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a></li>
                    <li><a href="/frontend/pages/Bapas/html/tracking.html"><i class="fas fa-map-marker-alt"></i> <span>Tracking Map</span></a></li>
