...
<head>
    ...
    <link rel="stylesheet" href="/frontend/pages/Lapas/css/dataNapi.css">
    <script src="/frontend/pages/Lapas/js/dataNapi.js"></script>
        ...
        <aside class="sidebar">
            ...
            <nav class="nav-links">
                <ul>
                    ...
                    <li><a href="/frontend/pages/Lapas/html/Laporan.html"><i class="fas fa-file-invoice"></i>
                            <span>Final Report</span></a></li>
                    <li><a href="/frontend/pages/Lapas/html/setting.html"><i class="fas fa-cog"></i>
