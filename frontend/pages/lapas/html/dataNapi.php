...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/wetrack/frontend/pages/Lapas/css/dataNapi.css">
    <script src="http://localhost/wetrack/frontend/pages/Lapas/js/dataNapi.js"></script>
        ...
        <aside class="sidebar">
            ...
            <nav class="nav-links">
                <ul>
                    ...
                    <li class="active"><a href="http://localhost/wetrack/frontend/pages/Lapas/html/data.html"><i class="fas fa-database"></i>
                            <span>Database</span></a></li>
                    <li><a href="http://localhost/wetrack/frontend/pages/Lapas/html/Laporan.html"><i class="fas fa-file-invoice"></i>
