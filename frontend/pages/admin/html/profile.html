...
<head>
    ...
    <link rel="stylesheet" href="/frontend/pages/Lapas/css/profile.css">
    <link
        ...
        <main class="content">
            ...
            <div class="profile-container">
                <div class="path-to-back">
                    <a href="/frontend/pages/Lapas/html/setting.html"><i class="fas fa-arrow-left"></i></a>
                </div>
                <h1>Administrative Staff</h1>
                <img src="/frontend/pages/Lapas/Image/lapas-logo.png" alt="Photo Profile">
                <h2>Serdy Fambo</h2>
                <p>NIP. 06-30-21</p>
