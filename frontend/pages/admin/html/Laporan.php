...
<head>
    ...
    <script src="/frontend/pages/Lapas/js/data.js"></script>
        ...
        <aside class="sidebar">
            ...
            <nav class="nav-links">
                <ul>
                    ...
                    <li><a href="/frontend/pages/Lapas/html/data.html"><i class="fas fa-database"></i>
                            <span>Database</span></a></li>
                    <li class="active"><a href="/frontend/pages/Lapas/html/Laporan.html"><i
