...
<body>
  <div class="sidebar">
    ...
    <ul>
      ...
      <li class="active"><a href="/frontend/pages/polri/html/profiles.html" style="color: inherit; text-decoration: none;">Profile</a></li>
  ...
  <script src="/frontend/pages/polri/js/profiles.js"></script>
</body>
</html>
