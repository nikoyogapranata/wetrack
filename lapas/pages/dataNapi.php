        ...
        <main class="content">
            <div class="profile-card">
                <div class="path-to-back">
                    <a href="http://localhost/wetrack/lapas/pages/data.php"><i class="fas fa-arrow-left"></i></a>
                </div>
                <div class="profile-header">
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo '<img src="http://localhost/wetrack/lapas/image/nanti-diganti.png" alt="Default Photo" class="profile-image">';
                    }
                    ?>
