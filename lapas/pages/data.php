...
if (isset($_POST["submit"])) {
    ...
    if (mysqli_query($conn, $query)) {
        ...
        document.location.href = '/wetrack/frontend/pages/lapas/pages/dataNapi.php';
        </script>
        ";
    } else {
...
<head>
    ...
    <link rel="icon" href="/wetrack/frontend/pages/Lapas/Image/wetrack-logo-white.png" type="Image/x-icon">
    <link rel="stylesheet" type="text/css" href="/wetrack/frontend/pages/lapas/css/data.css">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap"
        rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <script src="/wetrack/frontend/pages/lapas/js/data.js" defer></script>
</head>
    ...
    <div class="container">
        <aside class="sidebar">
            <div class="sidebar-header">
                <div class="logo">
                    <img src="/wetrack/frontend/pages/Lapas/Image/wetrack-logo-white.png" alt="WETRACK Logo">
            ...
            <nav class="nav-links">
                <ul>
                    <li><a href="/wetrack/frontend/pages/Lapas/pages/home.html"><i class="fas fa-tachometer-alt"></i>
                            <span>Dashboard</span></a></li>
                    <li class="active"><a href="/wetrack/frontend/pages/Lapas/pages/data.php"><i class="fas fa-database"></i>
                            <span>Database</span></a></li>
                    <li><a href="/wetrack/frontend/pages/Lapas/pages/Laporan.html"><i class="fas fa-file-invoice"></i><span>Final
                                Report</span></a></li>
                    <li><a href="/wetrack/frontend/pages//Lapas/pages/setting.html"><i class="fas fa-cog"></i>
                            <span>Settings</span></a></li>
                </ul>
            </nav>
            <div class="user-profile">
                <img src="/wetrack/frontend/pages/Lapas/Image/lapas-logo.png" alt="Profile picture" width="40" height="40">
                <div class="user-info">
                    <h2>Serdy Fambo</h2>
